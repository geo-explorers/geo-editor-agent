...
- **Upstream:** https://github.com/makenotion/notion-cookbook/tree/907dbde91795e180f7e6260305cf97a0456ff473/skills/claude/research-documentation
...
- Directory renamed `research-documentation` -> `notion-research-documentation` so it matches the `name:` field,
